        ...
        <div className="space-y-10 text-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              app. This policy explains what information we collect when you visit our site or use the app, how we use
              it, and your rights regarding that information. It also covers records we still hold from our earlier
              beta signup form, which is no longer available.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="font-medium mb-2">Beta signup form (no longer in use)</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
              AlgoPattern has launched and the beta signup form has been retired. We no longer collect signups
              through it. We still hold the records submitted while it was active. For those submissions, we
              collected:
            </p>
            <ul className="list-disc list-inside text-muted-foreground space-y-1 mb-4 ml-2">
              ...
              <li>Any additional comments shared in the form</li>
            </ul>
            <p className="text-muted-foreground leading-relaxed mb-6">
              We also recorded the date and time of the submission and an approximate country, detected automatically
              from the IP address using Vercel's built-in geolocation. IP addresses themselves were never stored by us
              or shared with any third party for this purpose.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-6">
              If you signed up during the beta and want your record removed, email us at{" "}
            ...
            <h3 className="font-medium mb-2">Purchases and subscriptions</h3>
            <p className="text-muted-foreground leading-relaxed mb-6">
              If you buy a subscription or a one-time purchase, the payment itself is processed by the Apple App Store
              or Google Play. We never receive or store your payment card details. Purchase state is managed on our
              side by RevenueCat, which tells us which product you bought, your current subscription status, renewal
              and expiration dates, and a store transaction identifier, linked to your account or anonymous app ID. We
              use this only to unlock the features you paid for and to restore your purchase across your devices.
            </p>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-1 mb-4 ml-2">
              ...
              <li>Button and link click events</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-2">
              ...
              <li>
                To reference retained beta signup responses when weighing what to build next, and to let people who
                signed up know the app is available
              </li>
              <li>To track and display your progress, streaks, and scores</li>
              <li>To provide paid access and restore your purchases across your devices</li>
              ...
              <li>
                To send product updates, new feature announcements, and tips to the email address
                associated with your account
              </li>
            </ul>
            <p className="text-muted-foreground leading-relaxed mt-4">
              You can unsubscribe from product update emails at any time using the link at the bottom of any such
              email. Account and security emails (for example, verification codes and password resets) are not
              promotional and will still be sent.
            </p>
            <p className="text-muted-foreground leading-relaxed mt-4">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Most of the third parties listed here act as data processors on our behalf: they receive only the data
              necessary to provide their service and are not permitted to use it for their own purposes. Apple and
              Google are the exception: when they process a purchase or authenticate a sign-in, they act on their own
              behalf under their own privacy policies, not as our processors.
            </p>
            <div className="space-y-4 text-muted-foreground">
              <div>
                <p className="font-medium text-foreground mb-1">Notion</p>
                <p className="leading-relaxed">
                  Submissions from our retired beta signup form are stored in a Notion database. We no longer send
                  new data to Notion. See{" "}
                  <a
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  ...
                  page interaction events tied to an anonymous identifier.
                  In the app, PostHog receives screen views, lifecycle events, custom usage events, session
                  recordings, and crash data. See{" "}
                  <a
              ...
              <div>
                <p className="font-medium text-foreground mb-1">RevenueCat</p>
                <p className="leading-relaxed">
                  RevenueCat validates purchase receipts from the Apple App Store and Google Play and tracks
                  subscription status on our behalf. It receives your app user identifier, purchase receipts, and
                  subscription state. It does not receive payment card details. See{" "}
                  <a
              ...
              <div>
                <p className="font-medium text-foreground mb-1">Apple and Google</p>
                <p className="leading-relaxed">
                  Purchases are processed by the Apple App Store or Google Play, which act as the seller of record.
                  They handle your payment details and any applicable taxes under their own privacy policies; we
                  receive only the purchase and subscription information described above.
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  Emails we send you — including account verification codes and product update emails — are
                  delivered via Resend. Resend receives the recipient email address in order to deliver the message.
                  See{" "}
                  <a
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              We retain beta signup records for as long as AlgoPattern is operating, and may contact the people who
              submitted them with relevant product updates. You can ask us to delete your record at any time.
            </p>
            <p className="text-muted-foreground leading-relaxed">
